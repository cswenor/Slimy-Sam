...
import com.convolutededge.androidgames.framework.Pixmap;
...
public class GameScreen extends Screen {
	...
	private void drawWorld(World world) {
		...
		Kitten kitten = world.kitten;
		
		Pixmap kittenPixmap = null;
		if(kitten.type == Kitten.TYPE_1)
			kittenPixmap = Assets.kitten1;
		if(kitten.type == Kitten.TYPE_2)
			kittenPixmap = Assets.kitten2;
		if(kitten.type == Kitten.TYPE_3)
			kittenPixmap = Assets.kitten3;
		int x = kitten.x * 32;
		int y = kitten.y * 32;
		g.drawPixmap(kittenPixmap, x, y);
	...
	private void drawGameOverUI() {
		...
		g.drawLine(0, 0416, 480, 416, Color.BLACK);
	}
